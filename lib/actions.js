...
module.exports = {
	...
	addOrganization: function(numberOfOrganizations, parentOrganizationId) {
		...
		function doAddOrganization(organizationName) {
			...
			return methods.addOrganization(organizationName, parentOrganizationId);
		}
	...
	addUser: function(numberOfUsers, organizationIds, userGroupIds) {
		...
		function doAddUser(userData) {
			...
			return methods.addUser(userData.firstName, userData.lastName, userData.screenName, userData.emailAddress, userData.male, organizationIds, userGroupIds,  COMPANY_ID);
		}
	...
	getOrganizations: function(parentOrganizationId) {
		return methods.getOrganizations(COMPANY_ID, parentOrganizationId);
	},
