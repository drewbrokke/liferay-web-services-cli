...
function get() {
	...
	var ORGANIZATION_OmitKeys = ['comments', 'countryId', 'createDate', 'logoId', 'modifiedDate', 'mvccVersion', 'regionId', 'statusId', 'userId', 'userName', 'uuid']; // Method configuration object
	...
	var DEFAULT_VALUES = {
		...
		Organization: {
			'add-organization': {
				omitFromResultsDisplayKeys: ORGANIZATION_OmitKeys,
				params: {
